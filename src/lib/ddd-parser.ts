...
const NATION_CODES: Record<number, string> = {
  ...
  0x06: 'B',  0x07: 'BG', 0x08: 'BIH', 0x09: 'BY',  0x0A: 'CH',
  0x0B: 'CY', 0x0C: 'CZ', 0x0D: 'D',  0x0E: 'DK',  0x0F: 'E',
  0x10: 'EST',0x11: 'F',  0x12: 'FIN', 0x13: 'FL',  0x14: 'GE',
  0x15: 'GB', 0x16: 'GR', 0x17: 'H',  0x18: 'HR',  0x19: 'I',
  0x1A: 'IRL',0x1B: 'IS', 0x1C: 'KZ', 0x1D: 'L',   0x1E: 'LT',
  0x1F: 'LV', 0x20: 'M',  0x21: 'MC', 0x22: 'MD',  0x23: 'MNE',
  0x24: 'MK', 0x25: 'N',  0x26: 'NL', 0x27: 'P',   0x28: 'PL',
  0x29: 'RO', 0x2A: 'RSM',0x2B: 'RUS',0x2C: 'S',   0x2D: 'SK',
  0x2E: 'SLO',0x2F: 'SRB',0x30: 'TR', 0x31: 'UA',  0x32: 'V',
  0x33: 'EC', 0xFD: 'EUR',0xFE: 'EC', 0xFF: '—',
};
...
function readName(r: BinaryReader): string {
  // Name structure per Annex 1C: codePage(1B) + name(35B) = 36B
  if (r.remaining < 36) return '';
  r.skip(1); // codePage — skip
